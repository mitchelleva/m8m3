import { CommonOptions, Data, DataInput, DataInputOptions, StoreType } from '../types';
...
export declare function updateInput(input: DataInput, newValue: any, path: string, store: StoreType): void;
